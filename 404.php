...
<html lang="en" class="light-style " dir="ltr" data-theme="theme-default" data-assets-path="../bakso/assets/" data-template="vertical-menu-template-free">
  ...
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
<link rel="stylesheet" href="../bakso/assets/vendor/css/pages/page-misc.css">
    <!-- Helpers -->
...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <a href="../" class="btn btn-primary">Back to page</a>
    <div class="mt-3">
      <img src="../bakso/assets/img/illustrations/page-misc-error-light.png" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png">
    </div>
  </div>
</div>
<!-- /Error -->
