        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
               @yield('admin'){{-- dashboard/admin.php --}}
               @yield('pimpinan'){{-- dashboard/pimpinan.php --}}
               @yield('rekam'){{-- bukuTamu/rekamTamuMasuk.php --}}
               @yield('data'){{-- bukuTamu/dataKunjungan.php --}}
               @yield('akun') {{-- settings/accountSettings.php --}}
            </div>
            <!-- / Content -->
