                    ...
                    <div class="col-md-10 order-md-1 mb-5">
                        <form class="needs-validation" novalidate>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control shadow-sm" id="address" autofocus placeholder="contoh : BPN (Badan Pertanahan Nasional)" required>
                            </div>
                            <div class="row">
                            ...
                            <div class="col-md-13 mb-3">
                                ...
                                <select class="custom-select d-block w-100" id="state" required>
                                    ...
                                    <option value="Kepala Bidang Pajak dan Retribusi Daerah">Kepala Bidang Pajak dan Retribusi Daerah</option>
                                    <option value="Kepala Bidang PBB dan BPHTB">kepala bidang PBB dan BPHTB</option>
                                    <option value="Kepala Bidang Pengendalian">Kepala Bidang Pengendalian</option>
                                </select>
                            </div>
                            <div class="mb-3">
